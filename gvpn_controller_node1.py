            ...
            if sock == self.sock or sock == self.sock_svr:
                ...
                if data[1] == tincan_control:
                    ...
                    if ip4_b2a(data[86:90]) == "66.220.158.68":
                        ...
                        ip_header += "\x48" # 72 
                        ip_header += "\x06" # 06 
                        ip_header += data[86:90]
                        checksum_ = checksum(ip_header)
                        new_ip_header = ip_header[0:10] + checksum_ + ip_header[12:20]
                        new_packet = data[56:70] + new_ip_header + data[90:]
                        logging.debug("Injecting to O/S network stack")
